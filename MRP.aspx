<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MRP.aspx.cs" Inherits="Production_Costing_Software.MRP" %>
                        ...
                        <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Always">
                            <ContentTemplate>
                                ...
                                <div class="container col-12">
                                    <asp:GridView ID="gvmrp" runat="server" AutoGenerateColumns="true" OnRowDataBound="gvmrp_RowDataBound" class="table table-bordered table-striped gridview" ClientIDMode="Static">
                                        <Columns>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            function bindDataTable() {
                $('#<%= gvmrp.ClientID %>').prepend($("<thead></thead>").append($('#<%= gvmrp.ClientID %>').find("tr:first"))).DataTable({
                    "destroy": true,
                    "paging": true,
                    "lengthChange": true,
                    "searching": true,
                ...
                table = $('#<%= gvmrp.ClientID %>').DataTable();
