<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="RMPriceEstimate.aspx.cs" Inherits="Production_Costing_Software.RMPriceEstimate" %>
                ...
                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                    <ContentTemplate>
                        <div class="card-body">
                            <div class="container col-12 ">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group mb-3" id="Divrfp">
                                            ...
                                            <div class="form-control">
                                                &nbsp;&nbsp;&nbsp;&nbsp;<asp:CheckBox runat="server" Enabled="false" onclick="purityclick();" CssClass="form-check-input" ID="chkpurity" />
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group mb-3">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text">Estimate Rate/Kg-Ltr(Rs)</span>
                                            </div>
                                            <asp:TextBox ID="txtratekgltr" CssClass="form-control" TextMode="Number" onchange="calculaterate();" runat="server"></asp:TextBox>
                                            <span class="input-group-text">ActualRate:(<asp:Label ID="lblActualRatePerKg" runat="server" Text=""></asp:Label>)</span>
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <asp:TextBox ID="txtquantity" CssClass="form-control" TextMode="Number" Enabled="false" runat="server"></asp:TextBox>
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group mb-3" id="Divpurity">
                                            ...
                                            <asp:TextBox ID="txtpuritypercent" CssClass="form-control" onchange="calculaterate();" Enabled="false" TextMode="Number" runat="server"></asp:TextBox>
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <asp:TextBox ID="txtactualprice" CssClass="form-control" Enabled="false" TextMode="Number" runat="server"></asp:TextBox>
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group mb-3">
                                            ...
                                            <asp:TextBox ID="txttransport" CssClass="form-control" onchange="calculaterate();" Enabled="false" TextMode="Number" runat="server"></asp:TextBox>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <asp:HiddenField ID="hdrmpemid" runat="server" />
                                        <asp:TextBox ID="lblRMPriceId" runat="server" Style="display: none"></asp:TextBox>
                            ...
                            <div class="container col-12">
                                <asp:GridView ID="gvrmpriceestimate" runat="server" AutoGenerateColumns="false"  class="table table-bordered table-striped gridview " ClientIDMode="Static">
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="">
                                            <ItemTemplate>
                                                <asp:Button ID="btnEdit" Text="Edit" runat="server" CommandArgument='<%#  Eval("RMPriceEstimateId") %>' OnClick="btnEdit_Click" CssClass="btn btn-sm btn-primary" />
                                                <asp:Button ID="btnDelete" Text="Delete" runat="server" CommandArgument='<%#  Eval("RMPriceEstimateId") %>' OnClick="btnDelete_Click" OnClientClick="return confirm('Are you sure want to delete this item?');" CssClass="btn btn-sm btn-danger" />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
                                </asp:GridView>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            function bindDataTable() {
                $('#<%= gvrmpriceestimate.ClientID %>').prepend($("<thead></thead>").append($('#<%= gvrmpriceestimate.ClientID %>').find("tr:first"))).DataTable({
                    "destroy": true,
                    "paging": true,
                    "lengthChange": true,
                    "searching": true,
        ...
        function drprmnamechange() {
            var rmcatId = document.getElementById('<%=drprmcategory.ClientID %>').value;

            var rmId = document.getElementById('<%=drprmname.ClientID %>').value;
            var lblRMPriceId = document.getElementById('<%=lblRMPriceId.ClientID %>');
            $.ajax({
                ...
                $.ajax({
                    url: 'WebService.asmx/GetActualRateKgByRM',
                    data: { RMCat: rmcatId, RMId: rmId },
                    method: 'POST',
                    success: function (r) {
                        ...
                        document.getElementById('<%=lblActualRatePerKg.ClientID %>').innerHTML = val1;
                        document.getElementById('<%=txttransport.ClientID %>').value = val2;
                        document.getElementById('<%=txtquantity.ClientID %>').value = val3;
                        document.getElementById('<%=lblRMPriceId.ClientID %>').value = val4;
                        var chkpurity = document.getElementById('<%=chkpurity.ClientID %>').value = val5;
                        document.getElementById('<%=txtpuritypercent.ClientID %>').value = val6;

                        if (chkpurity = true) {
                            document.getElementById('<%=chkpurity.ClientID %>').checked = true;

                        }
                        else {
                            document.getElementById('<%=chkpurity.ClientID %>').checked = false;
