...
{
    public partial class MRP : BasePage
    {
        ...
        {
            dt = mp.GET_MRPAll(Common.ConvertInt(Session["UserId"]));

            gvmrp.DataSource = dt;
            gvmrp.DataBind();
        }
        protected void gvmrp_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                int materialId = Common.ConvertInt(dr[6]);
