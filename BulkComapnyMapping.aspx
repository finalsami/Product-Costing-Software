<%@ Page Title="" Language="C#" MasterPageFile="~/Company.Master" AutoEventWireup="true" CodeBehind="BulkComapnyMapping.aspx.cs" Inherits="Production_Costing_Software.BulkComapnyMapping" %>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <div class="input-group mb-3">
                                            ...
                                            <asp:ListBox id="drpproductId" Rows="15" runat="server" CssClass="form-control" SelectionMode="Multiple"></asp:ListBox>
                                        </div>
                                ...
                                <asp:GridView ID="gvbulk" runat="server" AutoGenerateColumns="false" class="table table-bordered table-striped gridview " ClientIDMode="Static">
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="">
                                            <ItemTemplate>                                               
                                                <asp:Button ID="btnDelete" Text="Delete" runat="server" CommandArgument='<%#  Eval("BulkCompanyMappingId") %>' OnClick="btnDelete_Click" OnClientClick="return confirm('Are you sure want to delete this bulk?. Its also deleted from Price List');" CssClass="btn btn-sm btn-danger" />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
                                </asp:GridView>
